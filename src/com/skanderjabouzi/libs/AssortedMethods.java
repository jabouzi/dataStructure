package com.skanderjabouzi.libs;
...
public class AssortedMethods {
	...
	public  boolean randomBoolean(int percentTrue) {
		return randomIntInRange(1, 100) <= percentTrue;
	}
	
	public  boolean[][] randomBooleanMatrix(int M, int N, int percentTrue) {
	...
	public  LinkedListNode randomLinkedList(int N, int min, int max) {
	...
	public  LinkedListNode linkedListWithValue(int N, int value) {
	...
	public  LinkedListNode createLinkedListFromArray(int[] vals) {
	...
	public  String arrayToString(int[] array, int start, int end) {
	...
	public  String toFullBinaryString(int a) {
		String s = "";
		for (int i = 0; i < 32; i++) {
	...
	public  String toBaseNString(int a, int base) {
	...
	public  String listOfPointsToString(ArrayList<Point> list) {
	...
	public  TreeNode randomBST(int N, int min, int max) {
	...
	public  String[] getLongTextBlobAsStringList() {
		return getLongTextBlob().split(" ");
	}

	public  Trie getTrieDictionary() {
		return new Trie(getListOfWords());
	}
	
	public  HashSet<String> getWordListAsHashSet() {
